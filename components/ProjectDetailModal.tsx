...
export const ProjectDetailModal: React.FC<ProjectDetailModalProps> = ({
    ...
    isNewProject = false, isSaving = false, onSave
}) => {
                ...
                {isNewProject && (
                    <div className="flex-shrink-0 flex justify-end items-center gap-3 p-4 border-t border-gray-200 dark:border-[#363636] bg-gray-50 dark:bg-[#1e1e1e] rounded-b-xl">
                        ...
                        <button
                            ...
                            disabled={isSaving}
                            className="px-6 py-2 text-sm font-medium bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
                            {isSaving && (
